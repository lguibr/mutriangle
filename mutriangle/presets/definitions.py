...
DEFAULT_ENV_CONFIG = EnvConfig(
    ...
    NUM_SHAPE_SLOTS=3,
    REWARD_PER_CLEARED_TRIANGLE=5.0,
    REWARD_PER_PLACED_TRIANGLE=0.05,
    REWARD_PER_STEP_ALIVE=0.01,
    PENALTY_GAME_OVER=-3.0,
)
...
def get_toy_config() -> SavedConfigSet:
    ...
    toy_env_config = EnvConfig(
        ...
        NUM_SHAPE_SLOTS=3,
        REWARD_PER_PLACED_TRIANGLE=0.1,
        REWARD_PER_CLEARED_TRIANGLE=2.0,
        REWARD_PER_STEP_ALIVE=0.02,
        PENALTY_GAME_OVER=-2.0,
    )
...
def get_test_config() -> SavedConfigSet:
    ...
    return SavedConfigSet(
        ...
        model_config_data=ModelConfig(
            ...
            VALUE_HEAD_DIMS=[64],
            HIDDEN_STATE_DIM=128,
            REPRESENTATION_HIDDEN_DIMS=[128],
            DYNAMICS_HIDDEN_DIMS=[128],
            PREDICTION_HIDDEN_DIMS=[128],
            NUM_REWARD_ATOMS=51,
            REWARD_MIN=-10.0,
            REWARD_MAX=15.0,
            ACTIVATION_FUNCTION="ReLU",
...
def get_simple_config() -> SavedConfigSet:
    ...
    return SavedConfigSet(
        ...
        model_config_data=ModelConfig(
            ...
            VALUE_HEAD_DIMS=[128],
            HIDDEN_STATE_DIM=128,
            REPRESENTATION_HIDDEN_DIMS=[256],
            DYNAMICS_HIDDEN_DIMS=[256],
            PREDICTION_HIDDEN_DIMS=[256],
            NUM_REWARD_ATOMS=51,
            REWARD_MIN=-10.0,
            REWARD_MAX=15.0,
            ACTIVATION_FUNCTION="ReLU",
...
def get_large_config() -> SavedConfigSet:
    ...
    return SavedConfigSet(
        ...
        model_config_data=ModelConfig(
            ...
            VALUE_HEAD_DIMS=[256],
            HIDDEN_STATE_DIM=128,
            REPRESENTATION_HIDDEN_DIMS=[512, 256],
            DYNAMICS_HIDDEN_DIMS=[512],
            PREDICTION_HIDDEN_DIMS=[512],
            NUM_REWARD_ATOMS=51,
            REWARD_MIN=-10.0,
            REWARD_MAX=15.0,
            ACTIVATION_FUNCTION="GELU",
